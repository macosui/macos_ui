...
void main() {
  group('MacosTabView tests', () {
    testWidgets('Tapping a tab changes the child in view', (tester) async {
                  ...
                  builder: (context, _) {
                    return Padding(
                      ...
                      child: MacosTabView(
                        ...
                        children: const [
                          Center(child: Text('Tab child 1')),
                          Center(child: Text('Tab child 2')),
                          Center(child: Text('Tab child 3')),
                        ],
                      ),
                    );
                  },
