...
class MacosAutoCompleteField<T> extends StatefulWidget {
  ...
  /// Specifies if results should be shown when field is empty
  ///
  /// Defaults to true.
  ...
  /// Specifies the `TextEditingController` for [MacosAutoCompleteField].
  ...
  /// Use this to get the current search query of the [MacosAutoCompleteField].
  ///
  ...
  @override
  State<MacosAutoCompleteField<T>> createState() =>
      _MacosAutoCompleteFieldState();
}

class _MacosAutoCompleteFieldState<T> extends State<MacosAutoCompleteField<T>> {
        ...
        if (widget.results == null ||
          ...
          return TextFieldTapRegion(
            child: MacosOverlayFilter(
              borderRadius: _kBorderRadius,
              color: MacosAutoCompleteFieldTheme.of(context)
            ...
            onChanged: (query) {
              ...
              if (query.isEmpty) {
                suggestionStream.sink
                    .add(widget.showResultsWhenEmpty ? widget.results : null);
                return;
              }
              if (widget.results != null) {
...
class SearchResultItemButton extends StatefulWidget {
  // ignore: use_super_parameters
  const SearchResultItemButton({
    Key? key,
    this.onPressed,
    required this.child,
  ...
  @override
  State<SearchResultItemButton> createState() => _SearchResultItemButtonState();
}

class _SearchResultItemButtonState extends State<SearchResultItemButton> {
      ...
      child: GestureDetector(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            color: _isHovered
                ? MacosAutoCompleteFieldTheme.of(context).highlightColor
                : Colors.transparent,
            borderRadius: _kBorderRadius,
          ),
